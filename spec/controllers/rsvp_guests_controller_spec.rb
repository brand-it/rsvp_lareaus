...
RSpec.describe RsvpGuestsController, type: :controller do
  ...
  #     Wedding.create! valid_attributes
  ...
  #     get :edit, params: { id: wedding.to_param }, session: valid_session
  #     expect(response).to be_successful
  #   end
  # end
  ...
  #     wedding = Wedding.create! valid_attributes
  #     expect do
  #       delete :destroy, params: { id: wedding.to_param }, session: valid_session
  #     end.to change(Wedding, :count).by(-1)
  #   end

  #   it 'redirects to the weddings list' do
  #     wedding = Wedding.create! valid_attributes
  #     delete :destroy, params: { id: wedding.to_param }, session: valid_session
  #     expect(response).to redirect_to(weddings_url)
  #   end
  # end
end
